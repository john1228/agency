LazyLoad = function(m) {
    ...
    function l(a, b, g, k, d) {
        ...
        if (!p[a] && (u = p[a] = q[a].shift())) {
            ...
            b = u.urls;
            e = 0;
            for (h = b.length; e < h; ++e) g = b[e],
                r ? f = c.gecko ? s("style") : s("link", {
                    href: g,
                    rel: "stylesheet"
                }) : (f = s("script", {
                    src: g
                ...
                c.ie && !r && 10 > A.Version() ? f.onreadystatechange = function() { / loaded | complete / .test(f.readyState) && (f.onreadystatechange = null, l())
                }: r && (c.gecko || c.webkit) ? c.webkit ? (u.urls[e] = f.href, w()) : (f.innerHTML = '@import "' + g + '";', x(f)) : f.onload = f.onerror = l,
                t.push(f);
            e = 0;
